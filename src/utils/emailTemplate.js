...
export const SendTransactionEmail = async(email,name,amount,toAccount )=>{
  ...
  const text = `You have received ${amount} from ${name} to ${toAccount}`
...
<body>
  ...
  <p>You have received ${amount} from ${name} to ${toAccount}</p>
</body>
</html>`
...
export const SendTransactionFailedEmail = async(email,name,amount,toAccount )=>{
  const subject = "Transaction Notification"
  const text = `You have received ${amount} from ${name} to ${toAccount}`
  const html = `<!DOCTYPE html>
<html lang="en">
...
<body>
  <h1>Transaction Notification</h1>
  <p>hello ${name}, we regret to inform you that your transaction of ${amount} to ${toAccount} has failed</p>
</body>
</html>`
